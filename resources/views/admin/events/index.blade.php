        ...
        <table class="w-full bg-white rounded-lg shadow-sm border border-gray-200 text-left">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    <td class="p-4">
                        <img src="{{ ($event->poster_path && \Illuminate\Support\Facades\Storage::disk('public')->exists($event->poster_path)) ? asset('storage/' . $event->poster_path) : 'https://placehold.co/64x64' }}"
                            alt="Poster {{ $event->title }}" class="w-16 h-16 rounded-xl object-cover">
                    </td>
